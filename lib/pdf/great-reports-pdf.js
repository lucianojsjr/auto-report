...
let GreatReportsRenderer = require('./great-reports-pdf-renderer');
...
let GreatReportsPDF = function() {
	this.renderer = new GreatReportsRenderer();
 ...
 * @param template
 */
GreatReportsPDF.prototype.init = function(template) {
	if (!template) {
		throw new Error('No template was specified!');
	}
	
	//Add Default Style to Tables
	this.css = [`${__dirname}/../css/bootstrap.min.css`];
 ...
 * @param options
 */
GreatReportsPDF.prototype.config = function(options) {
	options = options || {};
 ...
 * @param value
 */
GreatReportsPDF.prototype.render = function(tag, value) {
	if (!tag) {
 ...
 * @param options
 */
GreatReportsPDF.prototype.renderTable = function(columns, values, options) {
	options = options || {};
 ...
 * @param options
 */
GreatReportsPDF.prototype.renderGroupedTable = function(columns, values, options) {
	options = options || {};
 ...
 * @returns {Promise}
 */
GreatReportsPDF.prototype.create = function(filepath) {
	if (!filepath) {
