 ...
 * @param properties
 */
GreatReportsPDFRenderer.renderGroupedTable = (columns, group, properties) => {
	const tag = 'table_grouped';
	const table = GreatReportsPDFTable.renderGroupedTable(columns, group, properties);
